...
class x_year_data extends DBObject {
    ...
    const METADATA = [
        ...
        'type' => 'ENUM("СМР","ПИР","Лимит ФБ","Лимит БМ","Лимит БМО","Лимит ОМСУ","РГ ФБ","РГ БМ","РГ БМО","РГ ОМСУ","РГ ОМСУ2","Нмцк ФБ","Нмцк БМ","Нмцк БМО","Нмцк ОМСУ","Нмцк ОМСУ2","Контракт ФБ","Контракт БМ","Контракт БМО","Контракт ОМСУ","Контракт ОМСУ2","Заявка ФБ","Заявка БМ","Заявка БМО","Заявка ОМСУ","Заявка ОМСУ2","Оплата ФБ","Оплата БМ","Оплата БМО","Оплата ОМСУ","Оплата ОМСУ2","Критерий","Снятие") NOT NULL',
        'value' => 'DECIMAL',
        'note' => 'VARCHAR(1024)',
        'PRIMARY KEY' => 'id',
